...
const pages = [
  ...
  {name: 'selections/top-10-beginner-shortcuts', chunks: ['index', 'switch']},
  {name: 'selections/top-10-simple-figma-shortcuts', chunks: ['index', 'switch']},
  {name: 'selections/top-10-users-shortcuts', chunks: ['index', 'switch']},
